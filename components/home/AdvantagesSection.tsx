...
export default function AdvantagesSection() {
  return (
    <section className="relative pt-6 lg:pt-14 pb-10 lg:pb-18 overflow-hidden">
      {/* edge glows */}
      <span className="pointer-events-none absolute left-[-100px] top-90 -z-10 h-[320px] w-[520px] rounded-full blur-[120px] opacity-90 mix-blend-multiply bg-[radial-gradient(60%_60%_at_40%_40%,#ffd4b8_0%,#ff5a4e_40%,rgba(255,90,78,0.28)_66%,transparent_80%)]" />
      <span className="pointer-events-none absolute right-[-80px] bottom-[-60px] -z-10 h-[360px] w-[520px] rounded-full blur-[120px] opacity-90 mix-blend-multiply bg-[radial-gradient(60%_60%_at_60%_60%,#ffe7b0_0%,#ff5a4e_38%,rgba(255,90,78,0.28)_66%,transparent_80%)]" />
